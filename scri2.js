...
let nombre6 = getRandomInt(10);

const secret = [nombre1, nombre2, nombre3, nombre4, nombre5, nombre6];
...
let htmlnombre6 = document.getElementById("nombre6");
...
bouton.addEventListener("click", function() {
 ...
 if (propoTexte.length !== 6) {
   alert("Vous devez entrer 6 chiffres");
   return;
 }
 ...
 let secretU = [false, false, false, false, false, false];
 let propoU = [false, false, false, false, false, false];
 ...
 if (bienP === 6) {
   ...
   htmlnombre6.textContent = nombre6;
 }
